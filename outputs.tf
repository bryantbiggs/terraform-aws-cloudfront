...
output "cloudfront_origin_access_identity_ids" {
  ...
  value       = [for v in aws_cloudfront_origin_access_identity.this : v.id if var.origin_access_identities]
}

output "cloudfront_origin_access_identity_iam_arns" {
  description = "The IAM arns of the origin access identities created"
  value       = [for v in aws_cloudfront_origin_access_identity.this : v.iam_arn if var.origin_access_identities]
}
